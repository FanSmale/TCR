...
public class TcrGUIAlone implements ActionListener, ItemListener {
	/**
	...
	public void actionPerformed(ActionEvent ae) {
		...
		// Read the data here.
		TCRAlone tempTcr = new TCRAlone(tempFilename, tempNumUsers, tempNumItems, tempNumRatings,
		...
		tempTcr.stage2Recommender.setParameters(tempRank, tempAlpha, tempLambda, tempAlgorithm, tempPretrainRounds);
