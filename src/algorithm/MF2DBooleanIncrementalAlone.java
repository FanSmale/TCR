...
public class MF2DBooleanIncrementalAlone extends MF2DBooleanAlone {
	/**
	 ...
	 ************************ 
	 */
	public MF2DBooleanIncrementalAlone(String paraFilename, int paraNumUsers, int paraNumItems,
	 ...
	 ************************ 
	 */
	public MF2DBooleanIncrementalAlone(RatingSystem2DBoolean paraDataset) {
		super(paraDataset);
	...
	public static void testIncremental(String paraFilename, int paraNumUsers, int paraNumItems,
		...
		MF2DBooleanIncrementalAlone tempLearner = new MF2DBooleanIncrementalAlone(tempDataset);
...
}// Of class MF2DBooleanIncrementalAlone
