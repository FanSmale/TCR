...
public class MF2DBooleanAlone extends UserBasedThreeWayRecommender {
	 ...
	 ************************ 
	 */
	public MF2DBooleanAlone(String paraFilename, int paraNumUsers, int paraNumItems,
	 ...
	 ************************ 
	 */
	public MF2DBooleanAlone(RatingSystem2DBoolean paraDataset) {
		super(paraDataset);
		dataset = paraDataset;
	...
	public static void testTrainingTesting(String paraFilename, int paraNumUsers, int paraNumItems,
		...
		try {
			...
			MF2DBooleanAlone tempLearner = new MF2DBooleanAlone(tempDataset);
